...
a_records = {
  ...
  # Clients/Linux Hosts
  #
  "client1"   = ["172.20.96.91"],
  "client2"   = ["172.20.96.92"],
  "client3"   = ["172.20.96.93"],
  "client4"   = ["172.20.96.94"],
  "client5"   = ["172.20.96.95"],
  "client6"   = ["172.20.96.96"],
  "client7"   = ["172.20.96.97"],
  "client8"   = ["172.20.96.98"],
  "client9"   = ["172.20.96.99"],
